...
int main(int argc, char *argv[])
{
  ...
  pointer =
      SymulatorGlowny.wskHistogramySymulacji->wskHistPunktyA->wskTablicyPrzedzialow;
  SymulatorGlowny.wskHistogramySymulacji->wskHistPunktyA->IloscDanychPrzedzMax =
      ZnajdzMax(pointer,
          SymulatorGlowny.wskHistogramySymulacji->wskHistPunktyA->IloscPrzedz);

  pointer =
      SymulatorGlowny.wskHistogramySymulacji->wskHistOdlAB->wskTablicyPrzedzialow;
  SymulatorGlowny.wskHistogramySymulacji->wskHistOdlAB->IloscDanychPrzedzMax =
      ZnajdzMax(pointer,
          SymulatorGlowny.wskHistogramySymulacji->wskHistOdlAB->IloscPrzedz);

  pointer =
      SymulatorGlowny.wskHistogramySymulacji->wskHistKatyGiec->wskTablicyPrzedzialow;
  SymulatorGlowny.wskHistogramySymulacji->wskHistKatyGiec->IloscDanychPrzedzMax =
      ZnajdzMax(pointer,
          SymulatorGlowny.wskHistogramySymulacji->wskHistKatyGiec->IloscPrzedz);

  pointer =
      SymulatorGlowny.wskHistogramySymulacji->wskHistOdlABrazyKatyGiec->wskTablicyPrzedzialow;
  SymulatorGlowny.wskHistogramySymulacji->wskHistOdlABrazyKatyGiec->IloscDanychPrzedzMax =
      ZnajdzMax(pointer,
          SymulatorGlowny.wskHistogramySymulacji->wskHistOdlABrazyKatyGiec->IloscPrzedz);
