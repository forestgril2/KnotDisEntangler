...
enum WidokStand
{
  ...
  YX,
  YZ, //np XY oznacza widok rownolegly do glebokosci Z ekranu;
  ZX,
  ZY  //stosuje sie tu uklad wspolrzednych, gdzie Z wzrasta w dol ekranu
};

enum KonfiguracjaStandWezla     //standardowe konfiguracja wezla
{
  Pierscien, Koniczynka
};
...
public:
  ...
  Knot3D(int IloscSegm1 = 4, double PromienPW = 1.0,
      const KonfiguracjaStandWezla& Konf1 = Pierscien, double DlugoscES = 0.05,
      const WidokStand& Widok1 = XY, int Numer3D1 = 1);
  ...
  int ZnajdzNajblSegm(int* const wskNr = NULL, int* const wskIle = NULL,
      Wektor3D* const wskW = NULL);  //znajduje numer elementu o
  //srodku masy najbli�szym
  //wektorowi3D, zaczynajac od

  int ZnajdzNajdalSegm(int* const wskNr = NULL, int* const wskIle = NULL,
      Wektor3D* const wskW = NULL);  //znajduje numer elementu o
  //srodku masy najbli�szym
  //wektorowi3D, zaczynajac od
...
public:
  ...
  bool SprawdzCzySaPrzekryciaPrzedzialu(int Poczatek, int Koniec, int Wiersz);

  double WyznaczDlugoscSegmSrednia(int Segment1 = 0, int Segment2 = 0);
  //wyznacza ja w podanym przedziale

  double WyznaczPromienMax(const Wektor3D& Punkt = Wektor3D(0.0, 0.0, 0.0));
  ...
  Wektor3D WyznaczMomentor(Knot3D* const wskKnot, const Wektor3D& Srodek =
...
public:
  ...
  Wektor3D WyznaczSrodekMasy(const int* wskTablicyNumerowPunktow, int Ile);
  ...
  Macierz3D WyznaczMacierzBezwl(const int* wskTablicyNumerowPunktow, int Ile);
  ...
  void StworzKonfStand(Wektor3D* wskTablicySegm,
      const KonfiguracjaStandWezla& Rodz = Pierscien, double Promien = 1.0,
