...
static int A,B,          	//przedzialy sprawdzane po gieciach
           nrmojebin=0,	
           nrmojetxt=0,
           nrbin=0,
           nrtxt=0,
           IleRazySONO=2500,
           IleRazyBONO=5000,
           CoIleUdanychGiecZapis=3000;

static long int LicznikStanowNizszejEnergii=0,
                LicznikStanowWyzszejEnergii=0,
                LicznikNieudanychGiec=0,
                LicznikUdanychGiec=0,
                LicznikProbGiec=0,
                LicznikSONO=0,
                LicznikBONO=0;
...
static double x=0,y=0,
              ...
              EnergiaNowa=0,
              EnergiaPocz=0,
              StosunekEnergiiDoPocz=1,
              StosunekEnergiiDoPoczMin=1,
              StosunekEnTermDoEnPocz=0.0001,
              WagaEnergiiOdpych=0,
 ...
 {//KOMUNIKATY KONSOLOWE
  ...
  cout<<"Stos. dl.: \t"<<DlugoscWezla/DlugoscWezlaPoczatkowa<<"\t|";
        cout<<"Stos. en.: \t"<<StosunekEnergiiDoPocz<<"\t|";
              cout<<"Stos. giec: \t"<<double(LicznikUdanychGiec)/double(LicznikBONO+1)<<"\t|";
