...
//--------------------------------------------------------------------------------
inline double StosunekGestosciStanowBoltzmanna(double EnergiaNowa,double EnergiaStara,double Temperatura)
{
...
{
 TYP Suma,
     SredniaWTablicy=Srednia(wskTablicy, Ilosc),
     Pomocnik;
...
TYP ZnajdzMin(TYP* wskTablicy, long int IloscDanych)
{
 ...
 TYP min=*wskTablicy;
 if(IloscDanych>0) {
    for (;IloscDanych--;++wskTablicy) if (*wskTablicy<min) min=*wskTablicy;}
 else {
    for (;IloscDanych++;--wskTablicy) if (*wskTablicy<min) min=*wskTablicy;}
 return min;
}
...
TYP ZnajdzMax(TYP* wskTablicy, long int IloscDanych)
{
 ...
 TYP max=*wskTablicy;
 if(IloscDanych>0) {
    for (;IloscDanych--;++wskTablicy) if (*wskTablicy>max) max=*wskTablicy;}
 else {
    for (;IloscDanych++;--wskTablicy) if (*wskTablicy>max) max=*wskTablicy;}
 return max;
}
