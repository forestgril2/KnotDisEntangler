...
char* LancuchyNazw[]={wskNazwyDomyslna,
		      wskNazwyWynikAuto,
		      wskNazwyWynikMoja,
...
int main(int argc, char *argv[])
{
     ...
     if(//(argv[nrParametruFunkcjiMain])[0]=='/'||   //czy jest znak parametru '-' lub '/' ?
        ...
        switch(Pomocnik[0])
        {
         case 'i':		//'i' oznacza input -  dalej nazwa pliku wczytyw.
             ...
             if(nrParametruFunkcjiMain>=argc||               //jesli nastepny argument pusty
               ...
               (argv[nrParametruFunkcjiMain])[0]=='-')
               {
                ...
                cout<<"\t(Zostanie uzyta domyslna nazwa: \t" <<wskNazwyDomyslna<<" \t)"<<endl;
             ...
             else
               {
                ...
                cout<<"Domyslna nazwa pliku wczytywania: \t"<<wskNazwyDomyslna<<endl;
                cout<<endl;
         ...
         case 'o':		//'o' oznacza output -  dalej nazwa pliku zapis
              ...
              if(nrParametruFunkcjiMain>=argc||                    //jesli nastepny argument pusty
                ...
                (argv[nrParametruFunkcjiMain])[0]=='-')
               {
                cout<<"UWAGA: nie podano nazwy pliku do automatycznego zapisu wynikow!"<<endl;
                cout<<"\t(Zostanie uzyta domyslna nazwa: \t" <<wskNazwyWynikAuto<<" \t)"<<endl;
                cout<<endl;
             ...
             else
               {
                ...
                cout<<"Domyslna nazwa pliku automatycznego zapisu: \t"<<wskNazwyWynikAuto<<endl;
                cout<<endl;
                nrPrzekazanegoLancucha++;
              };
             nrParametruFunkcjiMain++;
             ...
             if(nrParametruFunkcjiMain>=argc||     //jesli nastepny argument pusty
             ...
             else
               {
                ...
                if(NumerWczytywany==0)
                  {
                   cout<<"Numer wczytywany podano 0 albo lancuch textowy: \t"<<Pomocnik<<endl;
                   cout<<"\t(Wczytany zostanie pierwszy wezel pliku)"<<endl;
                  };
                nrParametruFunkcjiMain++;
               };
         ...
         default : //to na samym koncu, jak zaden parametr nie pasuje
             cout<<"UWAGA: podano pusty lub nieznany parametr (nie zostanie uzyty.)"<<endl;
             nrParametruFunkcjiMain++;
             break;
        }
       }
     else  //jesli nie ma oznaczenia parametru to przekazujemy lancuch/nazwe
       {
        if(nrPrzekazanegoLancucha<IloscLancuchowTextMax)
          {
           strcpy(LancuchyNazw[nrPrzekazanegoLancucha],argv[nrParametruFunkcjiMain]);
          }
        else
          {
           cout<<"UWAGA: Przekazano nadmierna ilosc lancuchow tekstowych! (Nie zostana uzyte.)"<<endl;
           cout<<endl;
          };
 ...
 cout<<"Nazwa pliku zapisu automatycznego (binarnie): \t"<<wskNazwyWynikAuto<<endl;
 cout<<"Nazwa pliku zapisu wyboru (binarnie): \t \t"<<wskNazwyWynikMoja<<endl;
 cout<<"Nazwa pliku zapisu automatycznego (tekstowo): \t"<<wskNazwyWynikAutotxt<<endl;
 cout<<"Nazwa pliku zapisu wyboru (tekstowo): \t \t"<<wskNazwyWynikMojatxt<<endl;
 cout<<endl;
