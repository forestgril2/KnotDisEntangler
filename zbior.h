...
public:
  ...
  struct wezel {
    ...
    wezel * poprzednik;
    // ------------ konstruktor
    wezel(typOBJ chowany) : nastepca(NULL) ,poprzednik(NULL)
    {
      wskobj = new typOBJ;
      *wskobj = chowany ;
    }
...
private :
  ...
  friend
  ostream & operator<<
    <typOBJ>    // <---- tak powinno byc, ale dla VC++ 6.0 trzeba to ujac w komentarz
...
///////////////////////////////////////////////////////////////
template <class typOBJ>
iteratorZbioru<typOBJ>
Zbior<typOBJ>::znajdz(typOBJ wzor)		       		// ((3))
{
...
template <class typOBJ>
iteratorZbioru<typOBJ>
Zbior<typOBJ>::gdzie_dac(typOBJ wzor)				// ((6))
{
...
public:
  ...
  // ----------konstruktor
  iteratorZbioru(Zbior<typOBJ> & pojem) : pojemnik(pojem)
  {
...
template <class typOBJ>
void
iteratorZbioru<typOBJ>::skocz_o(long nr)           		// ((10))
{
